...
static esp_err_t on_default_url(httpd_req_t *req)
{
  ...
  httpd_resp_sendstr(req, "hello world");//printar no navegador 
  return ESP_OK;
}
...
static void init_server()
{
  ...
  httpd_uri_t default_url = {// responde a os indereços 
      .uri = "/",
      .method = HTTP_GET,
...
void app_main(void)
{
    ...
    start_mdns_service();//funcao de inicializacao 
    init_server();//iniciando um servidor 
}